...
-- NOTE: I don't know what is this thing tbh Afsin
...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- NOTE: the scheme is named `habamax.nvim`, not `habamax` --
      -- plain `habamax` would silently load Neovim's builtin scheme instead.
